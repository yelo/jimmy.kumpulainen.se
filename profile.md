...
Backend, cloud, DevOps, and product engineering.
...
- **Email:** jimmy@kumpulainen.se
- **LinkedIn:** linkedin.com/in/jimmykumpulainen
- **GitHub:** github.com/yelo
...
### Trygg-Hansa
Systems Developer | Aug 2024 - Mar 2025
Built and maintained internal services and tools for claims, marketing, and insurance operations while helping move services from on-premises hosting to cloud-first delivery.
...
Delivered full-stack solutions for students and staff using .NET Core, Angular, Azure, Kubernetes, microservices, and real-time queues.

### P&L Nordic AB
Software Engineer | Aug 2018 - Apr 2019
Worked on front-end and back-end development with React, Redux, .NET Core, and Microsoft SQL Server.

### OptiWay AB
Software Engineer | Jan 2016 - Jul 2018
Built GIS-focused web applications with Angular, SignalR, OpenLayers, REST APIs, and .NET for festival planning and airport administration systems.

### Netville AB / Sony Mobile Communications
Android Developer | Nov 2013 - Jan 2016
Worked on Android and cloud-backed products, including Xperia Transfer Mobile, Backup & Restore, and system apps.

### Malmo University
Teaching Assistant | Jun 2011 - Jan 2013
Assisted students and corrected assignments for Web Development and Algorithmic's courses.
